...
func TestEncodedKeyOrdering(t *testing.T) {
	keys := []struct {
		...
		{
			tid: 1000, iid: 1, s: "/1000/1/NULL@1",
			vals: []sql.Value{nil},
			ver:  1,
		},
		{
			tid: 1000, iid: 1, s: "/1000/1/false@1",
			vals: []sql.Value{sql.BoolValue(false)},
			ver:  1,
		},
		{
			tid: 1000, iid: 1, s: "/1000/1/true@1",
			vals: []sql.Value{sql.BoolValue(true)},
			ver:  1,
		},
		{
			tid: 1000, iid: 1, s: "/1000/1/@1",
			vals: []sql.Value{sql.StringValue("")},
			ver:  1,
		},
		{
			tid: 1000, iid: 2, s: "/1000/2//NULL@1",
			vals: []sql.Value{sql.StringValue(""), nil},
			ver:  1,
		},
		{
			tid: 1000, iid: 2, s: "/1000/2//@1",
			vals: []sql.Value{sql.StringValue(""), sql.StringValue("")},
			ver:  1,
		},

		{
			tid: 1000, iid: 3, s: "/1000/3/-3456@1",
			vals: []sql.Value{sql.Int64Value(-3456)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/-345@1",
			vals: []sql.Value{sql.Int64Value(-345)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/0@1",
			vals: []sql.Value{sql.Int64Value(0)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/34@1",
			vals: []sql.Value{sql.Int64Value(34)},
			ver:  1,
		},
		{
		...
		{
			tid: 1000, iid: 3, s: "/1000/3/NaN@1",
			vals: []sql.Value{sql.Float64Value(math.NaN())},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/-123456.789@1",
			vals: []sql.Value{sql.Float64Value(-123456.789)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/-0.0012345@1",
			vals: []sql.Value{sql.Float64Value(-0.0012345)},
			ver:  1,
		},
		{
		...
		{
			tid: 1000, iid: 3, s: "/1000/3/12.345@1",
			vals: []sql.Value{sql.Float64Value(12.345)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/1.23456789e+12@1",
			vals: []sql.Value{sql.Float64Value(1234567890000)},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/@1",
			vals: []sql.Value{sql.StringValue("")},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/abc@1",
			vals: []sql.Value{sql.StringValue("abc")},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/abcd@1",
			vals: []sql.Value{sql.StringValue("abcd")},
			ver:  1,
		},
		{
			tid: 1000, iid: 3, s: "/1000/3/bc@1",
			vals: []sql.Value{sql.StringValue("bc")},
			ver:  1,
		},

		{
			tid: 1001, iid: 0, s: "/1001/0@1",
			ver: 1,
		},
		{
			tid: 1001, iid: 1, s: "/1001/1@1",
			ver: 1,
		},
		{
			tid: 1001, iid: 2, s: "/1001/2@1",
			ver: 1,
		},
		{
			tid: 1001, iid: 3, s: "/1001/3/4@1",
			vals: []sql.Value{sql.Int64Value(4)},
			ver:  1,
		},
		{
			tid: 1001, iid: 4, s: "/1001/4@1",
			ver: 1,
		},
		{
			tid: 1002, iid: 0, s: "/1002/0@1",
			ver: 1,
		},

		{
			tid: 1002, iid: 1, s: "/1002/1/123/abc@1",
			vals: []sql.Value{sql.Int64Value(123), sql.StringValue("abc")},
			ver:  1,
		},
		{
			tid: 1002, iid: 1, s: "/1002/1/123/def@1",
			vals: []sql.Value{sql.Int64Value(123), sql.StringValue("def")},
			ver:  1,
		},
		{
			tid: 1002, iid: 1, s: "/1002/1/456/abc@1",
			vals: []sql.Value{sql.Int64Value(456), sql.StringValue("abc")},
			ver:  1,
		},

		{
			tid: 1003, iid: 2, s: "/1003/2/1@18446744073709551615",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  0xFFFFFFFFFFFFFFFF,
		},
		{
			tid: 1003, iid: 2, s: "/1003/2/1@18446744073709551614",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  0xFFFFFFFFFFFFFFFE,
		},
		{
			tid: 1003, iid: 2, s: "/1003/2/1@18446744073709551600",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  0xFFFFFFFFFFFFFFF0,
		},
		{
			tid: 1003, iid: 2, s: "/1003/2/1@18446744069414584320",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  0xFFFFFFFF00000000,
		},
		{
			tid: 1003, iid: 2, s: "/1003/2/1@4294967295",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  0xFFFFFFFF,
		},
		{
			tid: 1003, iid: 2, s: "/1003/2/1@12345",
			vals: []sql.Value{sql.Int64Value(1)},
			ver:  12345,
		},
	}
