...
func (slt stepLockTable) lockTable(t *testing.T, ses *session, svc *service.LockService) {
	...
	err := svc.LockTable(ses.Context(), ses.tl, sql.TableName{sql.ID("db"), slt.tbl}, slt.ll)
	if slt.fail {
		if err == nil {
...
func TestService1(t *testing.T) {
	...
	steps := []testStep{
		...
		stepLocks{{Key: "db.tbl1", Locker: "locker-0", Level: service.ACCESS}},
		stepReleaseLocks{ses: 0},

		stepLockTable{ses: 0, tbl: tbl1, ll: service.EXCLUSIVE},
		stepLocks{{Key: "db.tbl1", Locker: "locker-0", Level: service.EXCLUSIVE}},
		stepLockTable{ses: 1, tbl: tbl2, ll: service.EXCLUSIVE},
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.EXCLUSIVE},
			{Key: "db.tbl2", Locker: "locker-1", Level: service.EXCLUSIVE},
		},
		stepReleaseLocks{ses: 0},
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ACCESS},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ACCESS},
			{Key: "db.tbl1", Locker: "locker-2", Level: service.ACCESS},
		},
		stepReleaseLocks{ses: 1},
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ACCESS},
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ACCESS},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY},
		},
		stepLockTable{ses: 0, tbl: tbl1, ll: service.ROW_MODIFY},
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ROW_MODIFY},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY},
		},
		stepLockTable{ses: 2, tbl: tbl1, ll: service.ACCESS},
		stepLocks{
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ACCESS},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.METADATA_MODIFY},
			{Key: "db.tbl1", Locker: "locker-2", Level: service.ACCESS},
		},
		stepReleaseLocks{ses: 2},
		stepReleaseLocks{ses: 1},
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.METADATA_MODIFY},
		},
		stepReleaseLocks{ses: 0},
	}
...
func TestService2(t *testing.T) {
	...
	steps := []testStep{
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.METADATA_MODIFY},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY, Place: 1},
		},
		stepReleaseLocks{ses: 0},
		stepWait{wg: &wg},
		stepLocks{
...
func TestService3(t *testing.T) {
	...
	steps := []testStep{
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.METADATA_MODIFY},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY, Place: 1},
			{Key: "db.tbl1", Locker: "locker-2", Level: service.ACCESS, Place: 2},
		},
		stepReleaseLocks{ses: 0},
		stepWait{wg: &wg},
		stepLocks{
...
func TestService4(t *testing.T) {
	...
	steps := []testStep{
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.METADATA_MODIFY},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY, Place: 1},
			{Key: "db.tbl1", Locker: "locker-2", Level: service.METADATA_MODIFY, Place: 2},
		},
		stepReleaseLocks{ses: 0},
		stepWait{wg: &wg},
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-1", Level: service.ROW_MODIFY},
			{Key: "db.tbl1", Locker: "locker-2", Level: service.METADATA_MODIFY, Place: 1},
		},
		stepReleaseLocks{ses: 1},
		stepWait{wg: &wg2},
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-2", Level: service.METADATA_MODIFY},
		},
		stepReleaseLocks{ses: 2},
	}
...
func TestService5(t *testing.T) {
	...
	steps := []testStep{
		...
		stepLocks{
			{Key: "db.tbl1", Locker: "locker-0", Level: service.ROW_MODIFY},
			{Key: "db.tbl1", Locker: "locker-1", Level: service.METADATA_MODIFY, Place: 1},
		},
		stepReleaseLocks{ses: 0},
		stepWait{wg: &wg},
		stepLocks{
